...
java -jar ~/GITREPO/rdf2xml/target/rdf2xml.jar model/ontoref.ttl model/Ontologie.md onto2md.xsl lang=nl
#java -jar ~/GITREPO/rdf2xml/target/rdf2xml.jar model/ontoref.ttl model/Ontologie.md ~/GITREPO/rdf2xml/rdf2md.xsl lang=nl
rm model/onto.ttl
