...
### Gebruikswijzer 
Met de bouwstenen oftewel de modelelementen die in dit metamodel beschreven zijn is een informatiemodel te maken. Om zo'n informatiemodel te maken volstaat het veelal om van het hoofdstuk [Metamodel Algemeen] door te nemen en te kiezen voor modellering met ofwel UML ofwel linked data en he tbijbehorende hoofdstuk te lezen. Neem vervolgens uw favorite modellertool en ga aan de slag. Voor bepaalde modelleertools heeft MIM hulpmiddellen gemaakt, zodat je met deze hulpmiddelen de modelelementen kan aanmaken door erop te klikken en bijvoorbeeld naar een diagram te slepen. Verder kan je de specificatie als geheel behandelen als naslagwerk, voor als er tijdens het modelleren vragen ontstaan. Tot slot is het mogelijk om naar informatiemodellen te kijken van organisaties die al een MIM  informatiemodel hebben gepubliceerd en voor specifieke modelleringen en vragen zullen er ook uitgewerkte voorbeelden worden gemaakt. 
