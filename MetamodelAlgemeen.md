...
<aside class="definition">
  <dfn data-lt="objecten">Object</dfn>Een fenomeen in de werkelijkheid.
</aside>
...
Ook digitale, virtuele en conceptuele dingen zijn fenomenen in de werkelijkheid en daarmee objecten. Met 'in de werkelijkheid' wordt bedoeld dat het om daadwerkelijke onderwerpen van gesprek gaat. Een object wordt ook wel een *exemplaar of instantie* van een objecttype genoemd (vele soortgelijke exemplaren samen zijn getypeerd naar een objecttype). 
