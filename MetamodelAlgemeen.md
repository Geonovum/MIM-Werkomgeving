...
Modelleertechnisch loopt de relatiesoort van Persoon (de bron van het relatietype) naar Organisatie (het doel van de relatiesoort) en de naam van de relatiesoort houdt rekening met deze richting. 

De relatiesoort 'werkt bij', of de relatierol 'werknemer'. hoort bij Persoon (de bron) en kan gezien worden een kenmerk van Persoon. Een kenmerk die als waarde de verwijzing naar de Organisatie (de organisatie zelf is uiteraard niet een kenmerk van de persoon) heeft. Merk op dat de relatiesoort twee objecttypen kan relateren die in twee aparte informatiedomeinen voorkomen. Het objecttype dat de bron is in de relatiesoort en de relatiesoort zelf worden dan in samenhang gedefinieerd, zonder dat het andere informatiedomein hier kennis van heeft. De definitie van deze relatiesoort wordt dan opgesteld vanuit het "eigen" informatiedomein, oftewel bekeken vanuit het objecttype dat de bron is in deze relatiesoort.
